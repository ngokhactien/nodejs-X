...
require('dotenv').config(); //console.log(process.env.KHACTIEN);
...
var cookieParser = require('cookie-parser'); // var csrf = require('csurf');


var mongoose = require('mongoose'); // mongoose.connect('mongodb://localhost/test', {useNewUrlParser: true, useUnifiedTopology: true});
...
var apiProductRoute = require('./api/routers/product.router');

var transferRoute = require('./router/transfer.route');
...
app.use(sessionMiddleware); // app.use(csrf({ cookie: true }));
//static file 
